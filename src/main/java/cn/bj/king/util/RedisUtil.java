...
public class RedisUtil{
     ...
     * @param time
     */
    private void expire(Object key,long time){
     ...
     * @return 成功个数
     */
    public long sSetAndTime(String key,long expire,Object...values) {
        try {
     ...
     * @return
     */
    public boolean lSet(String key, List<Object> value, long expire) {
        try {
            redisTemplate.opsForList().rightPushAll(key, value);
            if (expire > 0) {
                expire(key, expire);
