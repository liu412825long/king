...
public enum ErrorCodeEnum {
    ...
    ACCOUNT_IS_LOCKED("114", "账户被禁用，请联系我们解除禁用"),
    ILLEGAL_USERID("115", "用户名已存在", ""),
    IS_EXPIRED("116", "使用期限已经到期，请您及时续费"),
    ACCOUNT_IS_REVIEW("117", "账户正在审核中，请耐心等待"),
    ACCOUNT_IS_NO_PASS("118", "账户未通过审核，请联系我们。"),
    /**
     * 业务对象类异常
     */
